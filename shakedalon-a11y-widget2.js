(function() {
  ...
  const A11Y_STATEMENTS = {
    he: {
      ...
      commitment: {
        title: '\u05D4\u05DE\u05D7\u05D5\u05D9\u05D1\u05D5\u05EA \u05E9\u05DC\u05E0\u05D5',
        text: 'SHAKED ALON DESIGN \u05DE\u05D7\u05D5\u05D9\u05D1\u05EA \u05DC\u05D4\u05D1\u05D8\u05D7\u05EA \u05E0\u05D2\u05D9\u05E9\u05D5\u05EA \u05D3\u05D9\u05D2\u05D9\u05D8\u05DC\u05D9\u05EA \u05DC\u05DE\u05E9\u05EA\u05DE\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05D9\u05D5\u05EA \u05E9\u05D5\u05E0\u05D5\u05EA. \u05D0\u05E0\u05D5 \u05E2\u05D5\u05D1\u05D3\u05D9\u05DD \u05D1\u05D4\u05EA\u05D0\u05DE\u05D4 \u05DC\u05EA\u05E7\u05DF \u05EA\"\u05D9 5568 \u05D5\u05D7\u05D5\u05E7 \u05E9\u05D5\u05D5\u05D9\u05D5\u05DF \u05D6\u05DB\u05D5\u05D9\u05D5\u05EA \u05DC\u05D0\u05E0\u05E9\u05D9\u05DD \u05E2\u05DD \u05DE\u05D5\u05D2\u05D1\u05DC\u05D5\u05D9\u05D5\u05EA, \u05D4\u05EA\u05E9\u05E0"\u05D7-1998 (\u05EA\u05D9\u05E7\u05D5\u05DF \u05DE\u05E1\' 18).'
      },
      accessibility: {
  ...
  const ICONS = {
    ...
    accessibility: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="4" r="2"/><path d="M6 9h12v11H6z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M9 13h6"/><path d="M9 17h6" stroke="currentColor" stroke-width="2"/></svg>'
  };
  ...
  // Alt text badges (DOM-based instead of CSS)
  function showAltBadges() {
    ...
    document.querySelectorAll('img[alt]').forEach(function(img) {
      ...
      badge.style.cssText = 'position:absolute;background:#1565c0;color:#fff;padding:2px 6px;border-radius:3px;font-size:10px;z-index:999997;max-width:200px;word-wrap:break-word;pointer-events:none;';
  ...
  function applyFeatures() {
    ...
    if (state.largeBlackCursor) {
      const blackCursorCss = 'body' + EX + '{cursor:url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M2 2l8 20 3-8 8-3z" fill="black"/></svg>\') 2 2,auto!important}';
    ...
    if (state.largeWhiteCursor) {
      const whiteCursorCss = 'body' + EX + '{cursor:url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><path d="M2 2l8 20 3-8 8-3z" fill="white" stroke="black" stroke-width="1"/></svg>\') 2 2,auto!important}';
    ...
    if (state.readableFont) {
      const readableFontCss = 'body' + EX + '{font-family:"Segoe UI",Tahoma,Geneva,Verdana,sans-serif!important}';
  ...
  function applyAnimationStop() {
    if (state.stopAnimations) {
      ...
      state.pausedVideos.forEach(video => {
